...
if (!isCreator) return ads('Khusus Ariel SP')
...
ads('Mohon Tunggu 10 Detik, Bot Sedang Mencari Lagu Yang Anda Cari')
...
case prefix+'tiktok': case prefix+'tiktoknowm': {
 ...
 ads('Error Bang') 
   ...
   addCmd(command.slice(1), 1, commund)
  break
case prefix+'stickerwm': case prefix+'swm': {
if (isBan) return ads(mess.ban)
if (!q) return reply(`Example ${command} ${global.namebot}|Kece`)
arielsp1 = q.split("|")[0]
arielsp2 = q.split("|")[1]
